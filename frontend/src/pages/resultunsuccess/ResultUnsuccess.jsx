      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-blue-100/50 rounded-3xl p-8 shadow-lg">
          ...
          <div className="flex justify-center mb-8">
            <div className="bg-red-500 rounded-full p-6 inline-flex items-center justify-center">
              <AlertCircle size={48} className="text-white" />
              <div className="absolute mt-30 text-red-500 font-bold">NOT SAFE</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="bg-white rounded-md p-3 shadow-sm">Chatterpari</div>
              </div>
              <div>
                <label className="text-sm text-blue-600">Date of Test</label>
                <div className="bg-white rounded-md p-3 shadow-sm">15 March 2025</div>
              </div>
              <div>
                <label className="text-sm text-blue-600">TDS</label>
                <div className="bg-white rounded-md p-3 shadow-sm">450 ppm</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-white rounded-md p-3 shadow-sm">Natural Spring</div>
              </div>
              <div>
                <label className="text-sm text-blue-600">Last Test Date</label>
                <div className="bg-white rounded-md p-3 shadow-sm">15 May 2025</div>
              </div>
              <div>
                <label className="text-sm text-blue-600">pH Value</label>
                <div className="bg-white rounded-md p-3 shadow-sm">6.5</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="bg-white rounded-md p-4 shadow-sm mt-1 text-red-600">
              Urgent need for water filters in this area, Complaints of foul smell and taste were reported.
            </div>
          </div>
        </div>
      </div>
...
export default SearchResultUnsuccess;